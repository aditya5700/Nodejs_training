...
// const avgscoreDolphines = (96 + 108 + 108)/ 3
// console.log (avgscoreDolphines);

// const avgscoreKoalas = ( 97 + 112 + 110) / 3
// console.log (avgscoreKoalas);

// if ( avgscoreDolphines > avgscoreKoalas){
//     console.log("Dolphine wins!");
// } 
//  if ( avgscoreKoalas > avgscoreDolphines){
...
// Bonus challenge 
// const avgscoreDolphines = (96 + 108 + 96)/ 3
// console.log (avgscoreDolphines);

// const avgscoreKoalas = ( 97 + 112 + 90) / 3
// console.log (avgscoreKoalas);

// if ( avgscoreDolphines > avgscoreKoalas && avgscoreDolphines >= 100){
//     console.log("Dolphine wins!");
// } else if ( avgscoreKoalas > avgscoreDolphines && avgscoreKoalas >= 100){
//     console.log("Koalas wins!");
//  } else if ( avgscoreDolphines == avgscoreKoalas && avgscoreDolphines >= 100 && avgscoreKoalas >= 100){
//     console.log("Draw !!!");
//  } else {
